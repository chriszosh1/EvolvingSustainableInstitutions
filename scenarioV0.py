...
vv = []
#dto = {'tag': 'V0_fullrul', 'files':['per_period']}
dto = {'tag': 'S0_print_test', 'files':['final']}

#Run the model many times:
for r in range(1):
    scenario1 = Model(agent_count = agent_count, game_variables = gv, agent_variables = av, verbose_variables = vv, data_to_output = dto, run = r)
